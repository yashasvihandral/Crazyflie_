...
Go to: https://optitrack.com/support/downloads/archives.html

Scroll down to the Motive software section.

Click “previous releases.”

Select “Motive 2.2.0.”

Check the EULA box and follow the installation instructions.

Open Motive after installation (the license pop-up should appear).

Step 2: Enter License Information

On the Motive pop-up, click “license tool.”

Use the OptiTrack/Motive box to find the required license information and the hardware key USB.

Press “active” settings to save the information.

Close the License Tool window.

Click “retry” on the Motive pop-up. Motive should now launch.
...
Click the calibration pane (top right).
...
Grab the wanding tool.

Click “Start Wanding.”

Make sure no camera is highlighted so all cameras are included.

Walk to the middle of the testing space.

Walk in an outward spiral while moving the wand in large motions, including figure-8s, and twisting/bending the tool.

Click “Start Calculating.”

Keep samples under 10,000. Usually 2,000–5,000 samples are enough even if it shows poor quality.

Step 3.2: Set the Ground Plane

Grab the ground plane tool.

Place it in the middle of the testing space.

Point the longer side toward the back wall (forward-facing axis).

Use the levelers to level it with the lab floor. The bubble should be centered within the black lines.
...
Hold Ctrl and click each marker to select the markers for the rigid body.

Right-click, hover over “Rigid Body,” then select “Create from Selected Markers.”

A new rigid body should appear. Note the rigid body name (you can customize it) and the identification number.
